...
| E1 |   MUST   | 🟦 |  Créer un générateur de CSV pour les produits  | #1 |  Le générateur produit une chaîne de caractères qui représente les produits.  |    |
| E2 |   MUST   | ⬜ |  Télécharger un fichier à partir du générateur  | #1 |  Un bouton permet de télécharger un fichier construit à partir du générateur.  |    |
